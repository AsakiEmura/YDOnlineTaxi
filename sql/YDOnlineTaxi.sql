...
(
    status                   varchar(5)  default '未通过审核' not null comment '司机审核状态',
    phone_number             char(11)                    not null comment '手机号',
    id_photo_back            mediumtext                  null comment '身份证照片国旗面',
    id_photo_front           mediumtext                  not null comment '身份证照片人像面',
    motorcycle_type          varchar(64)                 not null comment '车型',
    license_plate_number     char(7)                     not null comment '车牌号',
    driver_name              varchar(64)                 not null comment '司机姓名',
    vehicle_license_photo    mediumtext                  not null comment '驾驶证照片',
    emergency_contact_number char(11)    default ''      null comment '紧急联系电话',
    driver_licence_photo     mediumtext                  not null comment '行驶证照片',
    salt                     varchar(45) default ''      null comment 'md5密码盐',
    id_number                char(18)                    not null comment '身份证号',
    driver_password          varchar(100)                not null comment '司机账户密码',
    address                  varchar(64)                 not null comment '地址',
    constraint driver_details_id_number_uindex
        unique (id_number),
    constraint driver_details_phone_number_uindex
        unique (phone_number)
)
    comment '司机详细信息';
...
(
    driver_name                           varchar(6)              not null comment '司机姓名',
    driver_phone_number                   char(11)                not null comment '司机电话',
    driver_car_id                         char(7)                 not null comment '司机车牌号',
    driver_level                          varchar(10) default '0' not null comment '司机等级',
    driver_complete_order_number_monthly  varchar(10) default '0' not null comment '司机月度完成单子数量',
    car_model                             varchar(15) default ''  null comment '汽车型号',
    driver_car_type                       varchar(6)              not null comment '司机车型',
    driver_emergency_contact_phone_number varchar(11) default ''  not null comment '司机紧急联系电话',
    driver_rate_number                    varchar(3)  default ''  not null comment '司机评分',
    driver_complete_order_number          varchar(10) default ''  not null comment '司机完成单子数量',
    constraint driver_phone_number
...
alter table driver_information
    add primary key (driver_phone_number);

create table financial_statistics
(
    driver_phone_number char(11)      default ''   not null comment '手机号',
    month_income        decimal(8, 2) default 0.00 null comment '月收入',
    driver_name         varchar(6)                 not null comment '司机姓名
',
    unpaid_remuneration decimal(8, 2) default 0.00 null comment '未支付报酬',
    total_income        decimal(8, 2) default 0.00 null comment '总收入',
    constraint financial_statistics_driver_phone_number_uindex
        unique (driver_phone_number)
)
    comment '财务统计';

alter table financial_statistics
    add primary key (driver_phone_number);
...
(
    departure           varchar(20)               not null comment '出发地',
    order_status        varchar(8)  default '已上线' not null comment '订单状态',
    remuneration        varchar(50)               not null comment '订单价格',
    requirement_types   varchar(5)                not null comment '需求类型',
    transport_time      varchar(28)               not null comment '用车时间',
    passenger_phone     char(11)                  not null comment '乘客联系手机',
    passenger           varchar(6)                not null comment '乘客称呼',
    destination         varchar(20)               not null comment '到达地',
    note                varchar(30) default ''    not null comment '订单备注',
    car_type            varchar(5)                not null comment '用车类型',
    statement_time      varchar(28) default ''    not null comment '结单时间',
    driver_phone_number char(11)    default ''    null comment '司机手机号',
    order_time          varchar(28) default ''    not null comment '接单时间',
