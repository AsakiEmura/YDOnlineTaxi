<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="奖惩原因" prop="rpReason">
        <el-input
          v-model="queryParams.rpReason"
          placeholder="请输入奖惩原因"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          @click="handleExport"
          v-hasPermi="['YDOnlineTaxi:log:export']"
        >导出
        </el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="logList" @selection-change="handleSelectionChange">
      ...
      <!--            v-hasPermi="['YDOnlineTaxi:log:edit']"-->
      <!--          >修改</el-button>-->
      <!--          <el-button-->
      <!--            size="mini"-->
      <!--            type="text"-->
      ...
      <!--            v-hasPermi="['YDOnlineTaxi:log:remove']"-->
      <!--          >删除</el-button>-->
      <!--        </template>-->
      <!--      </el-table-column>-->
    </el-table>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="奖惩原因" prop="rpReason">
          <el-input v-model="form.rpReason" placeholder="请输入奖惩原因"/>
        </el-form-item>
        <el-form-item label="操作时间" prop="operatingTime">
          <el-date-picker clearable size="small"
        ...
        <el-form-item label="操作人" prop="operatingPeople">
          <el-input v-model="form.operatingPeople" placeholder="请输入操作人"/>
        </el-form-item>
      </el-form>
...
<script>
import {addLog, delLog, exportLog, getLog, listLog, updateLog} from "@/api/YDOnlineTaxi/RPlog";
...
export default {
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      getLog(phoneNumber).then(response => {
